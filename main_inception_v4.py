...
def main():
    ...
    def test(test_loader, model):
        ...
        submission.to_csv('./result/%s/%s.csv' % (file_name, file_name), header=None, index=False)
        return
    ...
    def accuracy(y_pred, y_actual, topk=(1,)):
        ...
        if PRED_COUNT == 0:
            ...
            final_acc = PRED_CORRECT_COUNT * 1.0 / PRED_COUNT
    ...
    # 读取训练图片列表
    DATA_PATH = 'data'
    all_data = pd.read_csv(os.path.join(DATA_PATH, 'train.csv'))
